        ...
        <div className="app__header app__flex">
            ...
            >
                <div className="app__header-badge">
                    {/* Compact hero card */}
                    <motion.div
                        className="hero-card glass-card-compact"
                    ...
                    >
                        ...
                        >
                            ...
                            <h1 className="name-gradient">Enoch Kwabena Damoah</h1>
                            <p className="role-subtitle">
                                M.Eng. Student • Researcher • Full-Stack Developer
                            </p>
                            <div className="role-pills">
                                <span className="pill">🔬 AI/ML Research</span>
                                <span className="pill">🚀 Founder & CEO</span>
