...
}) => import("react").JSX.Element, useReporter: import("../../components/react-track-elements/createUseReporter").ReporterHook<FieldPresenceData>, useReportedValues: () => Reported<FieldPresenceData>[];
