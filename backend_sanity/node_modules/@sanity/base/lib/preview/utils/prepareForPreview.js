...
function prepareForPreview(rawValue, type) {
  ...
  var selectedValue = targetKeys.reduce((acc, key) => {
    ...
    var valueField = typeWithFields === null || typeWithFields === void 0 || (_typeWithFields$field = typeWithFields.fields) === null || _typeWithFields$field === void 0 ? void 0 : _typeWithFields$field.find(f => f.name === targetFieldName);
