...
var _excluded = ["allowedAutoPlacements", "children", "className", "content", "disabled", "fallbackPlacements", "placement", "portal", "tone"],
  _excluded2 = ["arrowStyle", "className", "content", "setArrowElement", "setPopperElement", "style", "tone"]; // @todo: remove the following line when part imports has been removed from this file
