...
export declare const PaneHeaderActions: React.MemoExoticComponent<({ initialValueTemplateItems: initialValueTemplateItemsFromStructure, menuItems, menuItemGroups, actionHandlers, }: PaneHeaderActionsProps) => React.JSX.Element>;
export {};
