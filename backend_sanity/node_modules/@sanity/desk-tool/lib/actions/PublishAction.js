...
var PublishAction = props => {
  ...
  var disabled = Boolean(publishScheduled || (editState === null || editState === void 0 || (_editState$transactio = editState.transactionSyncLock) === null || _editState$transactio === void 0 ? void 0 : _editState$transactio.enabled) || publishState === 'publishing' || publishState === 'published' || hasValidationErrors || publish.disabled);
  return {
