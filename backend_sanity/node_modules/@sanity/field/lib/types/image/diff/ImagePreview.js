...
var _templateObject, _templateObject2, _templateObject3; // @todo: remove the following line when part imports has been removed from this file
...
function ImagePreview(props) {
  var _diff$fromValue, _diff$toValue;
  var id = props.id,
    action = props.action,
    diff = props.diff,
  ...
  var assetChanged = ((_diff$fromValue = diff.fromValue) === null || _diff$fromValue === void 0 || (_diff$fromValue = _diff$fromValue.asset) === null || _diff$fromValue === void 0 ? void 0 : _diff$fromValue._ref) !== ((_diff$toValue = diff.toValue) === null || _diff$toValue === void 0 || (_diff$toValue = _diff$toValue.asset) === null || _diff$toValue === void 0 ? void 0 : _diff$toValue._ref);
