...
function Block(_ref) {
  ...
  if (diff.origin.action === 'changed' && diff.origin.fields.style && diff.origin.fields.style.action === 'changed' && diff.origin.fields.style.annotation) {
    var _diff$origin, _diff$origin$fields$s;
    fromStyle = diff === null || diff === void 0 || (_diff$origin = diff.origin) === null || _diff$origin === void 0 || (_diff$origin = _diff$origin.fromValue) === null || _diff$origin === void 0 ? void 0 : _diff$origin.style;
    var style = color ? {
